...
#define STRING_CONFIG_H_AUTHOR "(VTSTECH MARLIN 1.x MKS_GEN_L_V2 ANET_A8)" // Who made the changes.
#define SHOW_BOOTSCREEN
#define STRING_SPLASH_LINE1 "R16" // will be shown during bootup in line 1
#define STRING_SPLASH_LINE2 "github.com/Veritas83"         // will be shown during bootup in line 2
