...
#define STRING_CONFIG_H_AUTHOR "(VTSTech, MKS_GEN_L_V2 Anet A8 Config R10)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "VTSTech MKS_GEN_L_V2 Anet A8"
...
// Anet A8; true is 'OPEN' idle state
